...
public:
	...
	float max_vertical_angle;	/* The maximum angle magnitude the user can look up or down */
	...
	void update(ofVec3f direction, ofVec3f rotation, bool mouse_turning, float frame_time);
